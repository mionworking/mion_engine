...
inline constexpr const char* kPlayer = "player.ini";
inline constexpr const char* kProgression = "progression.ini";
inline constexpr const char* kTalents = "talents.ini";
inline constexpr const char* kEnemies = "enemies.ini";
