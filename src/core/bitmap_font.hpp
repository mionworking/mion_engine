...
static const uint8_t FONT_8X8[96][8] = {
    ...
    {0x82,0xC6,0xEE,0xFE,0xD6,0xC6,0xC6,0x00}, // 77 'M'
    ...
    {0xC6,0xC6,0xD6,0xFE,0xEE,0xC6,0x82,0x00}, // 87 'W'
    ...
    {0xC0,0xC0,0xDC,0xE6,0xC6,0xE6,0xDC,0x00}, // 98 'b'
    {0x00,0x00,0x7C,0xC6,0xC0,0xC6,0x7C,0x00}, // 99 'c'
    {0x06,0x06,0x76,0xCE,0xC6,0xCE,0x76,0x00}, // 100 'd'
    ...
    {0x06,0x00,0x06,0x06,0x06,0xC6,0x7C,0x00}, // 106 'j'
    {0xC0,0xC0,0xCC,0xD8,0xF8,0xCC,0xC6,0x00}, // 107 'k'
    ...
    {0x00,0x00,0xDC,0xE6,0xC6,0xFC,0xC0,0xC0}, // 112 'p'
    {0x00,0x00,0x76,0xCE,0xC6,0x7E,0x06,0x06}, // 113 'q'
    {0x00,0x00,0xDC,0xE6,0xC0,0xC0,0xC0,0x00}, // 114 'r'
    {0x00,0x00,0x7C,0xC6,0x70,0x1C,0xFC,0x00}, // 115 's'
    {0x30,0x30,0xFC,0x30,0x30,0x36,0x1C,0x00}, // 116 't'
    {0x00,0x00,0xC6,0xC6,0xC6,0xCE,0x76,0x00}, // 117 'u'
    {0x00,0x00,0xC6,0xC6,0xC6,0x7C,0x38,0x00}, // 118 'v'
        ...
        for (int row = 0; row < 8; ++row) {
            for (int col = 0; col < 8; ++col) {
                if (glyph[row] & (0x80u >> col)) {
                    SDL_FRect px = {
                        sx + (ci * 9 + col) * scale,  // 9 = 8px glyph + 1px kerning
                        sy + row * scale,
