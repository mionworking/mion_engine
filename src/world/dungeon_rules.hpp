...
/// XP concedida por morte de inimigo (espelha DungeonScene).
inline int xp_per_enemy_kill(int room_index) { return 14 + room_index * 6; }

/// Orçamento de spawn em modo normal (stress=false).
...
/// Área jogável da sala (origem em 0,0 — alinhado ao tilemap).
...
/// Template 0–3: combate normal; 4 boss/respiro; 5 intro.
...
/// Chave da secção em `data/rooms.ini` (ex.: `[arena]`, `[arena.obstacle.0]`).
